        ...
        <div class="row justify-content-md-center">
            <div class="col-md-9">
                <div class="card px-5 mt-3  shadow">
                    <h1 class="text-primary pt-4 text-center mb-4">Barcode Generator</h1>
                    
                    <form action="/post" method="post">
                        @csrf
                        <label for="">Document Type:</label>
                        <input type="text" class="form-control mb-3" name="document_type" required>

                        <label for="">Title:</label>
                        <input type="text" class="form-control mb-3" name="title" required>

                        <label for="">Sender:</label>
                        <input type="text" class="form-control mb-3" name="sender" required>

                        <label for="">Office:</label>
                        <input type="text" class="form-control mb-3" name="office" required>
